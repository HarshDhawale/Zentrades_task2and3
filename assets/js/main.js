document.addEventListener('DOMContentLoaded', function () {
    ...
    // Validate email format for the username field
    ...
    // Add masked functionality to the password field
    passwordInput.addEventListener('input', function () {
        this.value = this.value.replace(/[^A-Za-z0-9@]/g, '*'); // Mask the password, allow only alphanumeric and '@'
